...
#     # greet_future = robot.anim.play_animation_trigger("KnowledgeGraphSearchingGetIn")
#     # greet_future = robot.anim.play_animation("KnowledgeGraphSearching", loop_count=2)
#     # greet_future = robot.anim.play_animation("KnowledgeGraphSearching", loop_count=2)
#     # robot.anim.play_animation('anim_greeting_hello_01') 
#     robot.anim.play_animation('anim_knowledgegraph_searching_01') 

#     # greet_future = robot.anim.play_animation_trigger("KnowledgeGraphSearchingGetOutSuccess")
#     # greet_future = robot.anim.play_animation_trigger("KnowledgeGraphSuccessReaction")
...
robot = anki_vector.AsyncRobot(cache_animation_lists=False)
# Connect to Vector
robot.connect()
# Start saying text asynchronously
# say_future = robot.behavior.say_text("searching knowledge graph")
# # Turn robot, wait for completion
# turn_future = robot.behavior.turn_in_place(degrees(3 * 360))
# turn_future.result()
# Play greet animation trigger, wait for completion
# greet_future = robot.anim.play_animation_trigger("KnowledgeGraphGetIn")
# greet_future.result()
greet_future = robot.anim.play_animation_trigger("KnowledgeGraphSearching", loop_count=3)
greet_future.result()
# Make sure text has been spoken
# say_future.result()
